...
function Navigation(props : NavigationInterface) {
    return (<div className="Navigation--container">
        <form>
            <input data-testid="search" className="Navigation--search" onChange={(e)=>{props.setSearchTerm((e.target as HTMLInputElement).value)}} value={props.searchTerm} type="text" />
        </form>
